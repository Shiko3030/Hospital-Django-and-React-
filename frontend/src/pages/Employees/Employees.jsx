...
export default function Employees() {
    ...
    return (
        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <Link  to="/employee/create" class="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-transparent group-hover:dark:bg-transparent">
                    Create New Employee
                    </Link>
                    </button>
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" className="px-6 py-3">jop type</th>
                ...
                <tbody>
                    {employees.map(employee => (
                        <tr key={employee.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td className="px-6 py-4">{employee.job_type}</td>
                            <td className="px-6 py-4">{employee.specialization}</td>
                            <td className="px-6 py-4">{employee.phone}</td>
                            <td className="px-6 py-4">{employee.hire_date}</td>
